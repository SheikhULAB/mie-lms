...
const AcademicMockTests: React.FC = () => {
    ...
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="flex-1 p-6 space-y-6 overflow-y-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between p-4 text-white rounded-lg shadow-lg bg-gradient-to-r from-purple-500 to-blue-500">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-0">Mock Test Results</h2>
        ...
        {/* Content Section */}
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Academic Mock Tests</h2>
        <p className="mt-2 text-gray-600">Enroll now and start practicing for the IELTS Academic Test with 30 full mock tests!</p>
        ...
        <div className="grid grid-cols-1 gap-6 mt-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="p-6 transition-all duration-300 border border-gray-300 rounded-lg shadow-lg bg-gradient-to-r from-blue-100 to-blue-200 hover:shadow-2xl hover:scale-105">
            <h3 className="text-lg font-semibold text-gray-800">Academic Mock Test 1</h3>
          ...
          <div className="p-6 transition-all duration-300 border border-gray-300 rounded-lg shadow-lg bg-gradient-to-r from-red-100 to-red-200 hover:shadow-2xl hover:scale-105">
            <h3 className="text-lg font-semibold text-gray-800">Academic Mock Test 2</h3>
            <ul className="mt-4 space-y-2 text-gray-700">
              <li className="flex justify-between">
                <span>Listening</span>
          ...
          {/* Mock Test 3 */}
          <div className="p-6 transition-all duration-300 border border-gray-300 rounded-lg shadow-lg bg-gradient-to-r from-red-100 to-red-200 hover:shadow-2xl hover:scale-105">
            <h3 className="text-lg font-semibold text-gray-800">Academic Mock Test 3</h3>
            <ul className="mt-4 space-y-2 text-gray-700">
              <li className="flex justify-between">
                <span>Listening</span>
                <a href="/ielts-module/listeningtest" className="text-red-600 hover:underline">Take Test</a>
...
export default AcademicMockTests;
