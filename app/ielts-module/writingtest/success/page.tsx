...
const Success: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 via-purple-500 to-gray-500">
      <div className="max-w-lg p-8 bg-white rounded-lg shadow-lg">
        ...
        <p className="mb-6 text-lg text-center text-gray-600">
          Your IELTS Writing Test has been submitted successfully. Thank you for your participation.
        </p>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button
            onClick={() => router.push("/ielts-module/writingtest")}
