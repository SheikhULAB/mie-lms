...
const aMockTestPage: React.FC = () => {
  const router = useRouter();

  const handleMockClick = (link: string) => {
    // Navigate to the corresponding mock test page
    router.push(link);
  };
    ...
    <div>
      ...
      <div className="container flex flex-col px-4 mx-auto my-8">
        ...
        <div className="p-6 mb-8 bg-gray-100 rounded-lg shadow-lg">
          <h1 className="text-3xl font-semibold text-center text-gray-800">Academic IELTS MOCK</h1>
          <p className="mt-2 text-center text-gray-700">Choose your mock test set and prepare effectively for your IELTS exam.</p>
        </div>

        {/* Mock Test Sets */}
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 10 }, (_, index) => index + 1).map((setNumber) => (
            <div key={setNumber} className="overflow-hidden bg-white rounded-lg shadow-lg">
              <div className="grid grid-cols-2 gap-0">
                ...
                <div className="relative flex items-center justify-center bg-gradient-to-r from-red-200 to-red-300">
                  <div className="absolute inset-0 flex items-center justify-center transition duration-300 bg-black bg-opacity-50 opacity-0 hover:opacity-100">
                    <button
                      onClick={() => handleMockClick("/writing-test")}
                ...
                <div className="relative flex items-center justify-center bg-gradient-to-r from-blue-200 to-blue-300">
                  <div className="absolute inset-0 flex items-center justify-center transition duration-300 bg-black bg-opacity-50 opacity-0 hover:opacity-100">
                    <button
                      onClick={() => handleMockClick("/reading-test")}
                      className="text-lg font-semibold text-white hover:underline"
                    >
                ...
                <div className="relative flex items-center justify-center bg-gradient-to-r from-green-200 to-green-300">
                  <div className="absolute inset-0 flex items-center justify-center transition duration-300 bg-black bg-opacity-50 opacity-0 hover:opacity-100">
                    <button
                      onClick={() => handleMockClick("/listening-test")}
                      className="text-lg font-semibold text-white hover:underline"
                    >
                ...
                <div className="relative flex items-center justify-center bg-gradient-to-r from-purple-200 to-purple-300">
                  <div className="absolute inset-0 flex items-center justify-center transition duration-300 bg-black bg-opacity-50 opacity-0 hover:opacity-100">
                    <button
                      onClick={() => handleMockClick("/speaking-test")}
                      className="text-lg font-semibold text-white hover:underline"
                    >
              ...
              <div className="p-4">
                <h2 className="mb-2 text-xl font-semibold text-gray-800">Mock Test Set <span className="set-number">{setNumber}</span></h2>
                ...
                <button
                  onClick={() => handleMockClick("/sign-in")}
