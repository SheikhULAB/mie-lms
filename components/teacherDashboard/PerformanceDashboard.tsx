    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-auto">
        ...
        <section className="p-4 bg-white rounded-lg shadow-lg">
          <h2 className="text-3xl font-semibold text-gray-800">Student Performance Overview</h2>
          ...
          <div className="flex items-center justify-between p-2 mt-4 bg-gray-100 rounded-lg shadow">
            <div>
          ...
          <div className="mt-4 overflow-x-auto">
            <table className="min-w-full bg-white border border-gray-200">
              <thead className="bg-gray-100">
                <tr>
                  <th className="px-4 py-2 text-left text-gray-600">Mock Test</th>
                  <th className="px-4 py-2 text-left text-gray-600">Class</th>
                  <th className="px-4 py-2 text-left text-gray-600">Score</th>
                  <th className="px-4 py-2 text-left text-gray-600">Max Score</th>
                  <th className="px-4 py-2 text-left text-gray-600">Percentage</th>
                  <th className="px-4 py-2 text-left text-gray-600">IELTS Equivalent</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="px-4 py-2">Mock Test 1</td>
                ...
                <tr>
                  <td className="px-4 py-2">Mock Test 2</td>
                  <td className="px-4 py-2">Class 10B</td>
        ...
        <section className="p-4 bg-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-gray-800">Evaluation Test Performance</h2>
            ...
            <table className="min-w-full bg-white border border-gray-200">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left text-gray-600">Max Score</th>
                  <th className="px-4 py-2 text-left text-gray-600">Percentage</th>
                  <th className="px-4 py-2 text-left text-gray-600">Performance Ratio</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="px-4 py-2">Math Evaluation</td>
                  <td className="px-4 py-2">Class 10A</td>
                  <td className="px-4 py-2">80</td>
                  <td className="px-4 py-2">100</td>
                  <td className="px-4 py-2">80%</td>
                  <td className="px-4 py-2">1.06</td>
                </tr>
                <tr>
                  <td className="px-4 py-2">Science Evaluation</td>
                  <td className="px-4 py-2">Class 10B</td>
                  <td className="px-4 py-2">90</td>
                  <td className="px-4 py-2">100</td>
                  <td className="px-4 py-2">90%</td>
                  <td className="px-4 py-2">1.18</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="p-4 bg-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-gray-800">Performance Ratios & Analysis</h2>
          <p className="text-gray-600">
          ...
          <div className="mt-4">
            <div className="flex items-center space-x-4">
              <div className="w-1/2 p-4 text-white bg-blue-600 rounded-lg shadow-lg">
                <h3 className="text-xl font-semibold">Improvement Ratio</h3>
                <p className="mt-2 text-lg">1.12</p>
              </div>
              <div className="w-1/2 p-4 text-white bg-green-600 rounded-lg shadow-lg">
                <h3 className="text-xl font-semibold">Consistency Ratio</h3>
                <p className="mt-2 text-lg">0.95</p>
              </div>
            </div>
          </div>
        </section>
