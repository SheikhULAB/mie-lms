// components/StudentMockTest.tsx
"use client"
        ...
        <div className="flex h-screen">
            ...
            <div className="flex-1 p-6 space-y-6">
                ...
                <div className="flex items-center justify-between p-4 text-white rounded-lg shadow-lg bg-gradient-to-r from-purple-500 to-blue-500">
                    ...
                    <div className="space-x-4"> {/* Added space between buttons */}
                        <button
                        ...
                        <button
                            onClick={() => navigateTo('/studentdashboard/mocktest/general')} // Updated to use correct path
                            className="px-4 py-2 font-semibold text-purple-700 transition bg-white rounded-lg shadow hover:bg-purple-200"
                        >
                            General
                        </button>
                        <button
                            onClick={() => navigateTo('/ielts-module')} // Updated to use correct path
                            className="px-4 py-2 font-semibold text-purple-700 transition bg-white rounded-lg shadow hover:bg-purple-200"
                        >
                            Module-Based
                        </button>
